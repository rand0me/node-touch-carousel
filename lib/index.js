...
module.exports = (function($) {
    function TouchCarousel(element, options) {
        ...
        this._dragContainer = this.carouselRoot.find('.' + this.TOUCHCAROUSEL_CONTAINER_CLASS);

        // animate directly style for better performance
        this._dragContainerStyle = this._dragContainer[0].style;

        this._itemsWrapper = this._dragContainer.wrap($('<div class="' + this.TOUCHCAROUSEL_WRAPPER + '" />')).parent();
        //var itemsJQ = this._dragContainer.find('.touchcarousel-item');
        var itemsJQ = this._dragContainer.find('.' + this.ITEM_CLASS);
        ...
        if ('ontouchstart' in window) {
            ...
            if (this.settings.dragUsingMouse) {
                ...
                this._itemsWrapper.addClass(this.AUTO_CURSOR_CLASS);
            }
        ...
        itemsJQ.eq(this.numItems - 1).addClass(this.LAST_CLASS);
        ...
        itemsJQ.each(function(index) {
            ...
            jqItem.find('.' + this.NON_DRAGGABLE_CLASS).bind(self._downEvent, function(e) {
        ...
        if (this.settings.directionNav) {
            this._itemsWrapper.after('<a href="#" class="' + this.ARROW_HOLDER_CLASS + ' ' + this.LEFT_CLASS + '"><span class="' + this.ARROW_ICON_CLASS + ' ' + this.LEFT_CLASS + '"></span></a> <a href="#" class="' + this.ARROW_HOLDER_CLASS + ' ' + this.RIGHT_CLASS + '"><span class="' + this.ARROW_ICON_CLASS + ' ' + this.RIGHT_CLASS + '"></span></a>');
            this.arrowLeft = this.carouselRoot.find('.' + this.ARROW_HOLDER_CLASS + '.' + this.LEFT_CLASS);
            this.arrowRight = this.carouselRoot.find('.' + this.ARROW_HOLDER_CLASS + '.' + this.RIGHT_CLASS);
        ...
        if (this.settings.scrollbar) {
            this._scrollbarHolder = $('<div class="' + this.SCROLLBAR_HOLDER_CLASS + '"><div class="' + this.SCROLLBAR_CLASS + (this.settings.scrollbarTheme.toLowerCase() === this.LIGHT_CLASS ? ' ' + this.LIGHT_CLASS : ' ' + this.DARK_CLASS) + '"></div></div>');
            this._scrollbarHolder.appendTo(this.carouselRoot);
            this.scrollbarJQ = this._scrollbarHolder.find('.' + this.SCROLLBAR_CLASS);
    ...
    TouchCarousel.prototype = {
        ...
        TOUCHCAROUSEL_CONTAINER_CLASS: 'ark-touchcarousel-container',
        TOUCHCAROUSEL_WRAPPER: 'ark-touchcarousel-wrapper',
        ITEM_CLASS: 'ark-item',
        AUTO_CURSOR_CLASS: 'ark-auto-cursor',
        LAST_CLASS: 'ark-last',
        NON_DRAGGABLE_CLASS: 'ark-non-draggable',
        ARROW_HOLDER_CLASS: 'ark-arrow-holder',
        ARROW_ICON_CLASS: 'ark-arrow-icon',
        LEFT_CLASS: 'ark-left',
        RIGHT_CLASS: 'ark-right',
        SCROLLBAR_HOLDER_CLASS: 'ark-scrollbar-holder',
        SCROLLBAR_CLASS: 'ark-scrollbar',
        LIGHT_CLASS: 'ark-light',
        DARK_CLASS: 'ark-dark',
        DISABLED_CLASS: 'ark-disabled',
        CURRENT_CLASS: 'ark-current',

        GRABBING_CURSOR_CLASS: 'ark-grabbing-cursor',

        GRAB_CURSOR: 'ark-grab-cursor',
        ...
        updateCarouselSize: function(leavePos) {
            ...
            if (!this.settings.scrollToLast) {
                if (this.carouselWidth >= this._totalItemsWidth) {
                    ...
                    if (!this.settings.loopItems) {
                        this._arrowRightBlocked = true;
                        this.arrowRight.addClass(this.DISABLED_CLASS);
                        this._arrowLeftBlocked = true;
                        this.arrowLeft.addClass(this.DISABLED_CLASS);
                    }
                    this.setXPos(0);
                    return;
                    ...
                    this._arrowRightBlocked = false;
                    this._arrowLeftBlocked = false;
                    this.arrowRight.removeClass(this.DISABLED_CLASS);
                    this.arrowLeft.removeClass(this.DISABLED_CLASS);
                }
            }
        ...
        _updatePagingNav: function(id) {
            if (this._pagingEnabled) {
                ...
                if (this.settings.pagingNavControls) {
                    this._pagingItems.removeClass(this.CURRENT_CLASS);
                    this._pagingItems.eq(newPageId).addClass(this.CURRENT_CLASS);
                }
        ...
        _onDragRelease: function(e) {
            ...
            if (this._isDragging) {
                ...
                var getCorrectXPos = function (pos) {
        ...
        _setGrabCursor: function() {
            if (this._grabCursor) {
                ...
                this._itemsWrapper.removeClass(this.GRABBING_CURSOR_CLASS);
                this._itemsWrapper.addClass(this.GRAB_CURSOR);
            }
        ...
        _setGrabbingCursor: function() {
            if (this._grabbingCursor) {
                ...
                this._itemsWrapper.removeClass(this.GRAB_CURSOR);
                this._itemsWrapper.addClass(this.GRABBING_CURSOR_CLASS);
            }
        }
    };
